                      ...
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        ...
                        <div className="flex flex-wrap justify-end gap-1">
                          ...
                          <Button
                            ...
                            // fields now belong to the bill (edit there), and a
                            // sale already moved to a customer's tab has a
                          ...
                          <ConfirmDeleteButton
                            ...
                            // there — Bills tab Void/un-merge), and a sale moved to
                            // dues has a live tab charge referencing this row by id
                            // (lib/tabs.ts TAB_REF_SNACK_SALE) that plain delete
                            // never releases. Deleting either here would either
                            // desync the merged bill's line items or leave an
                            // orphaned tab charge with no source record — same
                            ...
                            // stock restored (useVoidSnackSale) and isn't merged or
                            // moved by definition, so it's always deletable here.
                            disabled={
