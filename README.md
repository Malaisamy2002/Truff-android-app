...
GitHub push/pull and the receipt `.zip` export/import now live under
**Advanced** inside Backup & restore and Receipts sharing.
...
npm run dev
```
# Truff-Snacks-Bookings-sales-management-Android-App
